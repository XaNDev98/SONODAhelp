function downloadPDF_Printpoint3() {
  ...
  const title = "COMANDOS PRINTPOINT 3";
  ...
  doc.addImage("../adress/Rep/printpoint_3.png", "PNG", xPosition, yPosition, imgWidth, imgHeight);

  // Baixa o PDF
  doc.save("comandosPrintpoint3.pdf");
}

// Adiciona o ouvinte de evento ao botão "Gerar PDF"
document.getElementById("generate-pdf_Printpoint3").addEventListener("click", downloadPDF_smartpoint);
